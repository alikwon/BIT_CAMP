...
public class PBUnivInfo extends PBInfo {
	...
	PBUnivInfo(String name, String phoneNum, String birth,int infoNumber, String address, String email, String major, String year) {
		super(name, phoneNum, birth, infoNumber);
		this.addr = address;
		this.email = email;
		this.major = major;
		this.year = year;
